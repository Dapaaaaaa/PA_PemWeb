        ...
        <div class="payment-content">
            ...
            <div class="qris-payment-box">
                ...
                <div class="payment-actions">
                    <a href="<?php echo $wa_link; ?>" target="_blank" class="btn-confirm-wa" id="waButton">
                    ...
                    <a href="index.php" class="btn-back-home" id="backButton" style="display: none;">Kembali ke Beranda</a>
                </div>
...
<script>
// Show back button after WA clicked
document.getElementById('waButton').addEventListener('click', function() {
    setTimeout(function() {
        document.getElementById('backButton').style.display = 'inline-block';
        if (window.showToast) {
            showToast('Silakan kirim bukti pembayaran ke WhatsApp, lalu klik "Kembali ke Beranda"', 'success', 4000);
        }
    }, 1000);
});
</script>
